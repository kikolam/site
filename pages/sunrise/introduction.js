...
export default () => (
  <Post>
    ...
    <Figure wide>
      <Image src="https://github.com/kikolam/site/raw/master/resources/sunrise.png" />
    </Figure>
    ...
    a phenomenon called scattering. On their path through the
    ...
    toxins, and promoting the synthesis of vitamin D. As the modern artificial
    ...
    can ease mental health issues and stress. The sun is a symbol of enlightenment,
    ...
    The sunrises locations move along the longitude throughout the day. The rotation of the earth around the
    ...
    <P>
    This installation, #Sunrise, is started for the above reasons, to create
